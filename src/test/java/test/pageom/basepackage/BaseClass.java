...
public class BaseClass extends KeyboardKeys {
	...
	public static void actionsRightClick(WebDriver driver,WebElement element) {
		Actions asc = new Actions(driver);
		asc.contextClick(element).perform();
	}

	public static void actionsDClick(WebDriver driver,WebElement element) {
		Actions asc = new Actions(driver);
		asc.doubleClick(element).perform();
	}

	public static void actionsDragDrop(WebDriver driver,WebElement drag_area, WebElement drop_area) {
		Actions asc = new Actions(driver);
		asc.dragAndDrop(drag_area, drop_area).perform();
	}

	public static void actionShiftPress(WebDriver driver,WebElement element, String input) {
		Actions asc = new Actions(driver);
	...
	public static void actionTypeWrite(WebDriver driver,WebElement element, String input) {
		Actions asc = new Actions(driver);
	...
	{
		File file = new File("/home/kumaresan/git/Full-Stack-QA-Automation-Testing/ProjectFrameworks/MavenOne/src/test/resources/demogurucredentials.properties");
		FileInputStream fis = new FileInputStream(file);
	...
	public static String reteriveElementTxtAssign(WebElement element)
	{
		return element.getText();
	}
	public static void reteriveElementTxt(WebElement element)
	{
